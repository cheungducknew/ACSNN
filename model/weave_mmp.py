...
class Weave_MMP(nn.Module):

    def __init__(self, args):
        super(Weave_MMP, self).__init__()
        ...
        # Same MLP layers as ACGCN_MMP and AttentiveFP_MMP
    ...
    def forward(self, batch_smiles1, batch_smiles2):
        ...
        # Same concatenation and MLP layers as ACGCN_MMP and AttentiveFP_MMP
